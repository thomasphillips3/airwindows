...
RawTimbers processes audio in the Dithers category. See the description above for specific functionality.
...
**Source Code**: [View on GitHub](https://github.com/airwindows/airwindows/tree/master/plugins/LinuxVST/src/RawTimbers)

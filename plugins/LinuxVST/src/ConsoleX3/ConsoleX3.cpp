...
VstInt32 ConsoleX3::getChunk (void** data, bool isPreset)
{
...
VstInt32 ConsoleX3::setChunk (void* data, VstInt32 byteSize, bool isPreset)
{	
	...
	ATK = pinParameter(chunkData[9]);
	RLS = pinParameter(chunkData[10]);
	RAT = pinParameter(chunkData[11]);
	
	TRM = pinParameter(chunkData[12]);
	MDE = pinParameter(chunkData[13]);
	SMO = pinParameter(chunkData[14]);
	MOR = pinParameter(chunkData[15]);
	
	LOP = pinParameter(chunkData[16]);
	LPQ = pinParameter(chunkData[17]);
	HIP = pinParameter(chunkData[18]);
	HPQ = pinParameter(chunkData[19]);
	
	PAN = pinParameter(chunkData[20]);
	FAD = pinParameter(chunkData[21]);
